...
void Widget::drawTile()
{
    ...
    data.map=importedDataEdit->text();
    data.style=stylesheetEdit->text();

    data.pluginName = pluginNameEdit->text();
    data.latTop = lattitudeTopEdit->text().toDouble();
    data.latBottom = lattitudeBottomEdit->text().toDouble();
    data.lonLeft = longitudeLeftEdit->text().toDouble();
    data.lonRight = longitudeRightEdit->text().toDouble();
    data.startLevel = startZoomEdit->text().toUInt();
    data.endLevel = endZoomEdit->text().toUInt();
